...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(idx => {
    const raisedToTheThird = Math.pow(idx, 3);
    numArray.push(raisedToTheThird);
  });
  return numArray;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i in arr) {
    integerArr.push(Math.pow(2, arr[i]));
  }
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach(idx => {
    const forLoopTwoToThe = Math.pow(2, idx);
    integerArr.push(forLoopTwoToThe);
  });
  return integerArr;
};
...
const mapTwoToThe = (arr) => {
  const mapArr = [];
  arr.map(idx => {
    const mapTwoToThe = (Math.pow(2, idx));
    mapArr.push(mapTwoToThe);
  });
  return mapArr;
